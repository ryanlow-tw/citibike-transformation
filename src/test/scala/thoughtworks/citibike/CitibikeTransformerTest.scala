  ...
  feature("Citibike Transformer Application") {
    ...
    scenario("Citibike Advanced Acceptance Test") {
      ...
      val expectedData = Array(
        ...
        Row(1067, "2017-07-01 00:16:31", "2017-07-01 00:34:19", 448, "W 37 St & 10 Ave", 40.75660359, -73.9979009, 487, "E 20 St & FDR Drive", 40.73314259, -73.97573881, 27084, "Subscriber", 1990, 2, 1.99)
      )
